    ...
    <div class="max-w-9xl mx-auto bg-white shadow-lg rounded-lg p-3">
        ...
        <div class="container mx-auto rounded-md shadow-sm bg-white border pl-1 pr-1 pt-1 pb-1 mb-2 flex flex-col space-y-5">
            ...
            <div class="container mx-auto rounded-md shadow-sm bg-blue-900 border pt-2 pb-2 flex items-center justify-between"> <!-- Added justify-between -->
                <a href="{{ route('admin.subUnitSummary') }}">
            ...
            <table class="min-w-full bg-white border border-gray-300">
                <thead>
                    <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        <th class="py-3 px-6 text-left border-r border-gray-300 w-40">Branch</th>
                        <th class="py-3 px-6 text-left border-r border-gray-300 w-40">Unit</th>
                        <th class="py-3 px-6 text-left border-r border-gray-300 w-40">Sub-unit</th>
                        <th class="py-3 px-6 text-left border-r border-gray-300">Issued</th>
                        <th class="py-3 px-6 text-left border-r border-gray-300 w-52">Issued (Prev. Year)</th>
                        ...
                        <th class="py-3 px-6 text-left border-r border-gray-300 w-40">CC Prev. Year</th>
                    </tr>
                </thead>
