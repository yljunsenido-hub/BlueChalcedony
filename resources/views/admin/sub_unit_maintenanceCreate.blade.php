        ...
        <div class="max-w-9xl mx-auto bg-white shadow-lg rounded-lg p-3">
            ...
            <div class="flex justify-between items-center bg-blue-900 text-white shadow-lg rounded-lg p-2 mb-3">
                <div class="flex-1 text-left">
                    <a href="/admin/sub_unit_maintenance" class="bg-yellow-400 hover:bg-white text-blue-900 font-bold py-1 px-2 rounded-md shadow-md transition duration-100 ease-in-out">
                        Back
                    </a>
                </div>
            </div>

            <div class="p-3 bg-white rounded-md shadow-md mt-3">
                <form action="/create-unit" method="POST">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700" for="unit-name">Sub-unit Name</label>
            ...
            <div class="flex justify-end mt-4">
                    <button type="submit" class="px-4 py-2 bg-green-500 text-white rounded-md hover:bg-green-600">Create New Sub-unit</button>
                </div>
