<x-app-layout>
    ...
    <div class="max-w-9xl mx-auto bg-white shadow-lg rounded-lg p-3 pb-5">
        ...
        <div class="flex border-b border-gray-300 mb-4">
            ...
            <a href="#" class="tab py-2 px-4 text-gray-600 hover:text-black font-semibold border-b-2 border-transparent hover:border-red-500 transition-all duration-300" id="tab5">C-Promotions</a>
            <a href="#" class="tab py-2 px-4 text-gray-600 hover:text-black font-semibold border-b-2 border-transparent hover:border-red-500 transition-all duration-300" id="tab6">D-Branch Incentives</a>
            <a href="#" class="tab py-2 px-4 text-gray-600 hover:text-black font-semibold border-b-2 border-transparent hover:border-red-500 transition-all duration-300" id="tab7">Z-Others</a>
        </div>
