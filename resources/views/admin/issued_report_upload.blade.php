            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-4">
                <div class="p-10 text-gray-900 dark:text-gray-100 flex justify-center">
                    <div class="bg-white p-6 rounded-lg shadow-md w-full sm:w-50"> <!-- Ensure full width responsiveness -->
                        <h2 class="text-4xl font-bold mb-4 text-center text-gray-800">Upload Issued Report</h2>

                        <!-- Notification Section -->
                        <div class="p-1 bg-blue-900 rounded-md shadow-md items-center">
                            <p class="text-md text-yellow-300 text-center">Upload CSV of Issued Cases</p>
                        </div>
                        ...
                        <div class="space-y-6 mt-5">
                            ...
                            <div class="flex justify-center items-center space-x-4 w-full"> <!-- Flexbox container to center items horizontally and vertically -->
                                
                                <!-- File input -->
                                <input type="file" id="file-upload" class="border border-gray-300 p-3 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-center" accept=".csv">
                                
                                <!-- Upload Button -->
                                <button onclick="confirmUpload()" class="w-40 bg-blue-600 text-white py-3 rounded-md hover:bg-blue-700 transition duration-300 text-center">
                                    UPLOAD CSV
                                </button>
                            </div>
